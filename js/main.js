// 弹框
function openTp(val1,val2,val3,val4,val5,val6){
    layer.open({
        content: val1, // 弹框内容
        closeBtn: 0,  // 去掉右上角的关闭按钮
        anim: val2, // 弹出动画
        btn: [val3, val4],  // 2个显示按钮名字
        yes: function(){
            // 提示但不关闭弹框
            alert(val5);
            return false;
...
function endfun(){
    ...
    $("body").append('<div class="velas">\n' +
        ...
        '</svg>')
        .append('<div class="text"><h1>happy birthday!</h1></div>')
        .append('<div style="text-align:center;clear:both"></div>');
}